  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-primary to-[hsl(280,65%,70%)] text-primary-foreground hover:shadow-[0_0_30px_hsl(var(--primary)/0.5)] shadow-lg hover:scale-105 font-semibold",
        success: "bg-success text-success-foreground hover:bg-success/90 shadow-md hover:shadow-lg",
        magic: "bg-gradient-to-r from-accent to-secondary text-foreground hover:shadow-[0_0_25px_hsl(var(--accent)/0.4)] shadow-md hover:scale-105 font-semibold",
      },
      size: {
